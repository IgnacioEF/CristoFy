 ...
 * @author Nacho
 */
public class CristofyServerTransmisionPhotoThread extends Thread{
    private int song_id = 0;
    private String login = null;
    private PrintWriter out = null;
    
    public CristofyServerTransmisionPhotoThread(int song_id, String login, PrintWriter out){
    ...
    public void run(){          
        ...
        try {
            path = "photo\\" + song.getUser(song_id) + "\\" + song.getTittle(song_id) + ".jpg";
        } catch (SQLException ex) {
            Logger.getLogger(CristofyServerTransmisionPhotoThread.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try{
            ...
            for(int i=0; i<num_packages; i++){
                ...
                System.out.println("");
                message = encodeUTF8("PROTOCOLCRISTOFY1.0#TRANSMISION_PHOTO_TO#" + this.login + "#" + this.song_id + "#" + Base64.getEncoder().encodeToString(bytesPackage));
                out.println(message);
            }
            ...
            out.println(message);
            System.out.println("PROTOCOLCRISTOFY1.0#TRANSMISION_PHOTO_TO#" + this.login + "#" + this.song_id + "#COMPLETED");
            out.println(encodeUTF8("PROTOCOLCRISTOFY1.0#TRANSMISION_PHOTO_TO#" + this.login + "#" + this.song_id + "#COMPLETED"));
